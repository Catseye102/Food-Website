				...
				<table class="tbl-cart" cellpadding="10" cellspacing="1">
					<tbody>
						...
						<tr>
							...
							<td align="right" colspan="2"><?php if (isset($_SESSION["cupon"]) and $_SESSION["cupon"]["status"]) {
						...
						<tr>
							<td align="middle" colspan="7"><strong>Cupon: </strong><?php if (!isset($_SESSION["cupon"])) { ?><form method="post" action="?action=addcupon" style="display:inline-block;"><input type="text" class="cupon" name="cupon-id"><input type="submit" value="Submit" class="btnCupon" /></form><?php } else {
																																																																														if ($_SESSION["cupon"]["status"]) {
																																																																															echo "success";
																																																																														} else {
																																																																															echo "invalid";
																																																																														} ?> <form method="post" action="?action=removecupon" style="display:inline-block;"><input type="submit" value="Remove Cupon" class="btnCupon" /></form> <?php } ?></td>
						</tr>
					</tbody>
				</table>
			<?php
