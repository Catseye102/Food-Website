...
class DBController
{
    ...
    function connectDB() // Shared by all
    {
        $conn = mysqli_connect($this->host, $this->user, $this->password, $this->database);
        return $conn;
    }

    function selectQuery($query) // Shared by all
    {
    ...
    function executeQuery($query) // Shared by all
    {
        mysqli_query($this->conn, $query);
    }

    function findIndexTable($table) // Contributed by Md Fuad Hasan [20101345]
    {
    ...
    function product_rating($prdct) // Contributed by F.M. Ashfaq [20101327]
    {
    ...
    function dropqueryparam() // Contributed by Md Fuad Hasan [20101345]
    {
        $base_url = strtok($_SERVER['REQUEST_URI'], '?');
        header('Location: ' . $base_url);
    }

    function printProducts4orderid($id) // Contributed by Md Fuad Hasan [20101345]
    {
    ...
    function status_update($order_id, $order_status) // Contributed by Hasnat Jamil Bhuiyan [20101411]
    {
    ...
    function orderQueue($id) // Contributed by F.M. Ashfaq [20101327]
    {
